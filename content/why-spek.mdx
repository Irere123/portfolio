...
summary: Why are you starting a platform for Real-time public communities
published: true
...
Based on my own experience, and all those groups I have approached, I am approaching the problem hands-on and building [Spek](https://github.com/withspek/spek) diffently, made for the purpose:
...
project is - <a target="_blank" href="https://github.com/withspek/spek">Open source</a>. Let's take developers communities to the stars ✨✨
